...
class Attendance_Manual_View_Only extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('Attendance/Attendance_Manual_View_Only/index', $data);
    }
...
on tbl_empmaster.EmpNo = tbl_manual_entry.Enroll_No
  {$filter}");

        $this->load->view('Attendance/Attendance_Manual_View_Only/search_data', $data);
    }
