...
class Edit_Employees_Outside extends CI_Controller
{
    ...
    public function update_emp1()
    {
        ...
        $DataID = $this->Db_model->getfilteredData("SELECT count(EmpID) AS ID FROM tbl_empmaster_outside WHERE Cmp_ID = '" . $Comp_No . "' AND Is_Approve = '1'");
        if ($DataID[0]->ID == 0) {
            ...
            if ($DataIDEmp[0]->ID == 0) {
                ...
                redirect('/Employee_Management/Outside_View_Employee/');
            } else {
