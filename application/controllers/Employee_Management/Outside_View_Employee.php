...
class Outside_View_Employee extends CI_Controller {
    ...
    public function search_employee() {
        ...
        // print_r(json_encode($data['data_set']));

        $this->load->view('Employee_Management/Outside_View_Employee/search_data', $data);
    }
