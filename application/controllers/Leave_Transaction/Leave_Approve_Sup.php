...
WHERE
  ...
  {$filter}");
    ...
    public function reject($ID)
    {
        ...
        $empname1 = $this->Db_model->getfilteredData("SELECT tbl_empmaster.EmpNo,tbl_empmaster.Grp_ID,tbl_empmaster.Emp_Full_Name,tbl_empmaster.E_mail,tbl_empmaster.username FROM tbl_empmaster WHERE tbl_empmaster.EmpNo = '$Emp_LV'");
        $groupid = $empname1[0]->Grp_ID;
        $empid = $empname1[0]->EmpNo;
        ...
        try {
            ...
            // Email content
            // $mail->isHTML(true);
            $mailSubject = "VFT Cloud: Leave Rejected";
