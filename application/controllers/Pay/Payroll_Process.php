...
class Payroll_Process extends CI_Controller
{
    ...
    /*
     * Payroll Process/public_html/sts.hrislkonline.com/application/controllers/Pay/Payroll_Process.php
     */
    ...
    public function emp_payroll_process()
    {
        ...
        for ($x = 0; $x < count($dtEmp['EmpData']); $x++) {
            ...
            if ($HasRow[0]->HasRow > 0) {
                ...
                // Easy code
                $deductionsIndices = range(0, 2); // Indices from 0 to 8
                // $Deductions[0]->Ded_ID
                ...
                */
                ...
                $Tot_deductions = $payee_now_amount + $EPF_Worker + $Sal_advance + $Festivel_Advance + $uniform + $other + $deduction1 + $deduction2 + $LoanMonth + $Nopay_Deduction + $tbMobile_Ded + $tbFuel_Ded;
                ...
                //Calculate Total Deductions
                $Tot_deductions = $payee_now_amount + $EPF_Worker + $Sal_advance + $Festivel_Advance + $uniform + $other + $deduction1 + $deduction2 + $LoanMonth + $Late_Amount + $Nopay_Deduction + $ed_amount;
