...
class Salary_Advance_View extends CI_Controller {
    ...
    public function index() {
        ...
        $data['title'] = "Salary Advance Approve| HRM SYSTEM";
...
//        $data['data_loan'] = $this->Db_model->getData('id,loan_name', 'tbl_loan_types');
        $this->load->view('Payroll/Salary_Advance_View/index', $data);
    }
