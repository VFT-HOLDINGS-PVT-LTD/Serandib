    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            foreach ($data_set as $data) {
                ...
                echo "<td width='100'>" . $data->RYear . "</td>";
                echo "<td width='100'>" . $data->RMonth . "</td>";
                echo "<td width='100'>" . $data->FDate . "</td>";
                echo "<td width='100'>" . $data->FTime . "</td>";
                echo "<td width='100'>" . $data->TTime . "</td>";
