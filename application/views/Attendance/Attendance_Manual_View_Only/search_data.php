            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    foreach ($data_set as $data) {
                        ...
                        if ($data->Is_Admin_App_ID == 0 && $data->Is_App_Sup_User == 0 && $data->Is_Cancel == 0) {
                            echo "<td width='15'>";
                        ...
                        if ($data->Is_Cancel == 0 && $data->Is_Admin_App_ID == 1 && $data->Is_App_Sup_User == 1) {
                            echo "<td width='15'>";
...
//                        echo "</td>";
                    ...
                    //     echo "<td width='15'>";
                    //     echo "<a class='get_data btn btn-primary' href='" . base_url() . "Attendance/Attendance_Manual_Entry_SAPP/approve/" . $data->M_ID . "'>APPROVE<i class=''></i> </a>";
                    //     echo "</td>";

                    //    echo "<td width='15'>";
                    //    echo "<a class='get_data btn btn-danger' href='" . base_url() . "Attendance/Attendance_Manual_Entry_SAPP/ajax_StatusReject/" . $data->M_ID . "'>REJECT<i class=''></i> </a>";
                    //    echo "</td>";
