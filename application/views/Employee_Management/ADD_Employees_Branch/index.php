                                                    ...
                                                    <div class="panel-body ">
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="horizontal-form">
                                                                <form class="form-horizontal" id="frm_employee" name="frm_employee" action="<?php echo base_url(); ?>Employee_Management/ADD_Employees_Branch/insert_Data" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" id="txt_emp_no" name="txt_emp_no" placeholder="Ex: 1" required="">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" id="txt_emp_name_init" name="txt_emp_name_init" required="" placeholder="Ex:L A Rathsara">
                                                                            </div>
...
<!--                                                                        <div class="form-group col-sm-6">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" id="cmb_branch" name="cmb_branch" required="">
                                                                                    <option value="" default>-- Select --</option>
...
<!--                                                                            <div class="form-group col-md-12">
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        ...
                        $("#spnmessage").hide("shake", {times: 5}, 3500);
                    });
                </script>
                ...
                <script type="text/javascript">
                    ...
                    function check_availability() {
                        ...
                        $.post(baseurl + "Employee_Management/ADD_Employees/check_emp", {EmpNo: username},
                                function (result) {
                                    //if the result is 1
                                    if (result == 1) {
