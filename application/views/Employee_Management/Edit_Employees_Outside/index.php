...
<body class="infobar-offcanvas">
    ...
    <script>
        function loadAdvancePayrollData(companyId) {
            fetch(`<?php echo base_url(); ?>Employee_Management/Edit_Employees_Outside/getData/${companyId}`)
    ...
    <script>
        ...
        function loadAcademicData() {
            ...
            fetch(`<?php echo base_url(); ?>Employee_Management/Edit_Employees_Outside/getAcademicData/${companyId}`)
                .then(response => response.json())
                .then(data => {
                    const qualifications = data.academic_data || [];

                    console.log('Academic Data:', qualifications);
    ...
    <script>
        document.getElementById("employeeForm").addEventListener("submit", function (e) {
            ...
            // ✅ Submit to backend
            fetch("<?php echo base_url(); ?>Employee_Management/Edit_Employees_Outside/update_emp", {
                method: "POST",
                body: formData,
            })
                .then(res => res.json())
