            ...
            <div class="new-modal-body">
                <div class="new-progress-container">
                    <div class="new-progress-steps">
                        <span>Step <span id="currentStep">1</span> of
                            4</span>
                        <span><span id="progressPercent">25</span>%
                            Complete</span>
                    </div>
                ...
                <form id="setupForm">
                    ...
                    <div class="new-step active" id="step1">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-sm-5">
                                <label for="focusedinput" class="col-sm-4 control-label">Group
                                    Name</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txt_group_name" name="txt_group_name"
                            ...
                            <div class="form-group col-sm-5">
                                <label for="focusedinput" class="col-sm-4 control-label">Group
                                    Supervisor</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="txt_supervisor_search"
                                        id="txt_supervisor_search" placeholder="Search by ID or Name">
                    ...
                    <div class="new-step" id="step2">
                        ...
                        <div class="new-form-group">
                            ...
                            <div class="new-error-message" id="usernameError">Please
                                choose
                                a username</div>
                        </div>
                        ...
                        <div class="new-form-row">
                            <div class="new-form-group">
                                ...
                                <div class="new-error-message" id="passwordError">
                                    Password
                                    must be at least 8
                                    characters
                                </div>
                            ...
                            <div class="new-form-group">
                                <label class="new-form-label" for="confirmPassword">Confirm
                                    Password</label>
                                <input type="password" class="new-form-control" id="confirmPassword" required>
                                <div class="new-error-message" id="confirmPasswordError">
                    ...
                    <div class="new-step" id="step3">
                        ...
                        <div class="new-form-group">
                            <label class="new-form-label">Notification
                                Settings</label>
                            ...
                            <div class="new-checkbox-group">
                                <label class="new-checkbox-label">
                                    ...
                                    <span class="new-checkbox-text"><strong>Email
                                            Notifications</strong></span>
                                </label>
                                <div class="new-checkbox-description">
                                    Receive important
                                    updates
                                    via email</div>
                            </div>
                            ...
                            <div class="new-checkbox-group">
                                <label class="new-checkbox-label">
                                    ...
                                    <span class="new-custom-checkbox"></span>
                                    <span class="new-checkbox-text"><strong>Push
                                            Notifications</strong></span>
                                </label>
                                <div class="new-checkbox-description">
                        ...
                        <div class="new-form-group">
                            <label class="new-form-label" for="theme">Theme
                                Preference</label>
                            <select class="new-form-control" id="theme" required>
                                <option value="" disabled selected>Select a theme
                                </option>
                            ...
                            <div class="new-error-message" id="themeError">Please
                                select a
                                theme</div>
                        </div>
                    </div>
                    ...
                    <div class="new-step" id="step4">
                        ...
                        <div class="new-terms-agreement">
                            <label class="new-checkbox-label">
                                ...
                                <span class="new-custom-checkbox"></span>
                                <span class="new-checkbox-text">I
                                    agree to the Terms of
                                    Service and Privacy
                                    Policy</span>
                            </label>
                            <div class="new-error-message" id="termsError">You must
                                agree
                                to the terms</div>
                        </div>
                    </div>
