                                                                        ...
                                                                        <form id="setupForm">
                                                                            ...
                                                                            <div class="new-step" id="step2">
                                                                                ...
                                                                                <div class="new-form-group">
                                                                                    ...
                                                                                    <div class="new-error-message"
                                                                                        id="usernameError">Please choose
                                                                                        a username</div>
                                                                                </div>
                                                                            ...
                                                                            <div class="new-step" id="step3">
                                                                                <h3 class="new-step-title">Preferences
                                                                                </h3>
