                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="index.html">SALARY ADVANCE VIEW</a></li>
...
//                alert(branch_code);
            ...
            <script>
                ...
                $("#search").click(function () {
                    ...
                    $('#search_body').load("<?php echo base_url(); ?>Pay/Salary_Advance_View/getSal_Advance", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'cmb_loan_type': $('#cmb_loan_type').val(), 'cmb_years': $('#cmb_years').val(), 'cmb_months': $('#cmb_months').val()});
                });
