                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            <div class="panel-heading"><h2>ADD SALARY INCREMENT</h2></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading"><h2>VIEW SALARY INCREMENT</h2></div>
                                                    <div class="panel-body">
...
//                            $('#cmb_cat2').remove();
            ...
            <script>
                ...
                $("#search").click(function () {
                    ...
                    $('#search_body').load("<?php echo base_url(); ?>Pay/Salary_Increment/getAllIncrements", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'cmb_month': $('#cmb_month').val(),'cmb_years': $('#cmb_years').val(),'cmb_allowances': $('#cmb_allowances').val()});
                });
