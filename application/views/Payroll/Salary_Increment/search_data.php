...
<!--                        <th>EDIT</th>
                ...
                <tbody>
                    ...
                    foreach ($data_set as $data) {
                        ...
                        echo "<td width='100'>" . number_format($data->Old_Salary, 2, '.', ',')  . "</td>";
                        echo "<td width='100'>" . number_format($data->Increment_amount, 2, '.', ',') . "</td>";
                        echo "<td width='100'>" . number_format($data->New_Salary, 2, '.', ',')  . "</td>";
                        echo "<td width='100'>" . $data->iMonth . "</td>";
                        echo "<td width='100'>" . $data->iYear . "</td>";



//                        echo "<td width='15'>";
//                        echo "<button class='get_data btn btn-green'  data-toggle='modal' data-target='#myModal' title='EDIT' data-id='$data->SI_ID ' href='" . base_url() . "index.php/Pay/Allowance/get_details" . $data->SI_ID  . "'><i class='fa fa-edit'></i></button>";
//                        echo "</td>";
//
//                        echo "<td width='15'>";
//                        echo "<button  class=' btn btn-danger' data-toggle='modal' href='javascript:void()' title='DELETE' onclick='delete_id($data->SI_ID )'><i class='fa fa-times-circle'></i></a>";
//                        echo "</td>";
