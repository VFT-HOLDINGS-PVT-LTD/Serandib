    ...
    <div id="wrapper">
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="index.html">STAMP DUTY</a></li>
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab1">STAMP DUTY</a></li>
                                <li><a data-toggle="tab" href="#tab2">EDIT STAMP DUTY</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            <h2>ADD STAMP DUTY</h2>
                                                        </div>
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_variable_allowances" name="frm_variable_allowances" action="<?php echo base_url(); ?>Pay/Stamp_duty/insert_data" method="POST">
        ...
        <script>
            ...
            $("#search").click(function() {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Pay/Stamp_duty/getAllowances", {
                    'txt_emp': $('#txt_emp').val(),
