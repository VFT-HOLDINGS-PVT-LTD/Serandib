    ...
    <div id="wrapper">
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="index.html">WELFAIR</a></li>
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab1">WELFAIR</a></li>
                                <li><a data-toggle="tab" href="#tab2">EDIT WELFAIR</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_variable_allowances" name="frm_variable_allowances" action="<?php echo base_url(); ?>Pay/Welfair/insert_data" method="POST">
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput" class="col-sm-4 control-label">Welfair Type</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" required="" id="cmb_allowance" name="cmb_allowance">
                                                                            ...
                                                                            <?php foreach ($data_alw as $t_data) { ?>
                                                                                <option value="<?php echo $t_data->ID; ?>"><?php echo $t_data->Welfair_name; ?></option>
                                                                ...
                                                                <div class="form-group col-sm-6" style="display: block;" id="monthSelector">
        ...
        <!-- <script>
            document.addEventListener('DOMContentLoaded', function() {
                document.getElementById('isFixed').addEventListener('change', function() {
                    alert("ok");
                    document.getElementById('monthSelector').style.display = this.checked ? 'none' : 'block';
                });
            });
        </script> -->
        ...
        <script>
            ...
            $("#search").click(function() {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Pay/Welfair/getAllowances", {
                    'txt_emp': $('#txt_emp').val(),
