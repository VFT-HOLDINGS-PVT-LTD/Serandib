                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_deduction_variable" name="frm_deduction_variable" action="<?php echo base_url(); ?>Pay/Deduction/insert_data" method="POST">
                                                                    ...
                                                                    <div class="form-group col-sm-12">
                                                                        <div class="col-sm-8">
                                                                            <img style="margin-left: 30%; width: 100px; height: 100px;" src="<?php echo base_url(); ?>assets/images/deductions.png" >
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Deduction Type</label>
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" required="" id="cmb_deduction" name="cmb_deduction" >


                                                                                <option value="" default>-- Select --</option>
                                                                                <?php foreach ($data_ded as $t_data) { ?>
                                                                                    <option value="<?php echo $t_data->Ded_ID; ?>" ><?php echo $t_data->Deduction_name; ?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading"><h2>EDIT DEDUCTION</h2></div>
                                                    <div class="panel-body">
...
//                            $('#cmb_cat2').remove();
            ...
            <script>
                ...
                $("#search").click(function () {
                    ...
                    $('#search_body').load("<?php echo base_url(); ?>Pay/Deduction/getDeductions", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'cmb_months': $('#cmb_months').val(), 'cmb_years': $('#cmb_years').val(), 'cmb_deductions': $('#cmb_deductions').val()});
                });
