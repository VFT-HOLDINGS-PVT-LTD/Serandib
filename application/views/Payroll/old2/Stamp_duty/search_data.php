    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo base_url(); ?>Pay/Stamp_duty/edit" method="post">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="focusedinput" class="col-sm-4 control-label">STAMP DUTY</label>
                        <div class="col-sm-8">
                            <input value="" type="text" name="stamp_duty" id="stamp_duty"  class="form-control m-wrap span6"><br>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(".get_data").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "index.php/Pay/Stamp_duty/get_details",
            data: {'id': ID},
            dataType: "JSON",
        ...
        swal({title: "Are you sure?", text: "You will not be able to recover this data!", type: "warning", showCancelButton: true, confirmButtonColor: "#DD6B55", confirmButtonText: "Yes, Delete This!", cancelButtonText: "No, Cancel This!", closeOnConfirm: false, closeOnCancel: false},
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            url: baseurl + "index.php/Pay/Stamp_duty/ajax_delete/" + id,
                            type: "POST",
                            dataType: "JSON",
                        ...
                        $(document).ready(function () {
                            setTimeout(function () {
                                window.location.replace(baseurl + "Pay/Stamp_duty");
                            }, 1000);
                        });
