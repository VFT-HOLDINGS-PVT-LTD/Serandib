                                        ...
                                        <div class="col-lg-11 col-md-12">
                                            <div class="card-body text-center">
                                                ...
                                                <a href="../main/index.html"
                                                    ...
                                                    <img src="assets/images/company/Serandib-Logo.png" class="dark-logo"
                                                        alt="Logo-Dark" style="width: 230px;" />
                                                </a>
                                                <h3 class="lh-base mb-4">Let's get you signed in</h3>

                                                <form class="form-horizontal" id="frmLogin" name="frmLogin"
                                                    action="<?php echo base_url() ?>login/verifyUser" method="POST">
                                                    <!-- <div class="mb-3">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="password" class="form-control" id="txt_password"
                                                            name="txt_password" placeholder="Password" required="">
                                                    </div>
                                                    ...
                                                    <div id="divmessage">
                                                        <center>
                                                            <div id="spnmessage"
                                                                style="color: #002640;font-weight: bold; margin-top: 0px;">
                                                            </div>
                                                        </center>
                                                    </div>
                                                    <button type="submit" id="btnSubmit" name="btnSubmit"
                                                        class="btn btn-dark w-100 py-8 mb-4 rounded-1"
                                                        style="background-color:#0675ba ; border-color: #0675ba; font-weight: bold;">Sign
                                                        In</button>
